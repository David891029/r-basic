...
<div id="sec-narrativa" class="section">
  ...
  <div class="card" style="border-left:4px solid #FFE600">
    ...
    <table>
      ...
      <tr>
        ...
        <td>KPIs de ahorro → gráfica de barras → hoja de ruta</td>
        <td>"Entonces, ¿qué haría yo en los primeros 90 días?" (señala la gráfica) "Dos cosas sin inversión, dos con datos adicionales."</td>
  ...
  <div class="card" style="border-left:4px solid #3483FA">
    <h3>🎬 Cierre (30 segundos — última cosa que dices, estás en ⚡ Recomendaciones)</h3>
    <p style="font-size:14px;line-height:2">
